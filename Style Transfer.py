...
for beta in betas:
    ...
    while total_loss > 0:
        ...
        if total_loss < 1:
            ...
            plt.axis('off')
            plt.title(f'Final image Iteration {ii} loss ={total_loss}')
            plt.savefig(f'iteration_{ii}.png')
        ...
        if ii % show_every == 0:
            ...
            plt.imshow(im_convert(target))
            plt.axis('off')
            plt.title(f'Iteration {ii} loss ={total_loss}')
            plt.savefig(f'iteration_{ii}.png')  # Save the image
